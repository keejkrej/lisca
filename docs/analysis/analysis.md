...
Column contracts: [`schema.md`](./schema.md).

| Path                                                                                                                              | Role                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `assay.json`                                                                                                                      | Nested domain contract (`type`, `data`, `workspace`, `interval`, `samples`, optional `analysis` with `channels` / `sampleChannels`)                                                                                                                                                                                                                                                                                                   |
| `bbox/PosN.csv`                                                                                                                   | Site boxes. Required columns: `roi`, `x`, `y`, `w`, `h`. Identity is `roi` only (`crop` is not accepted). Optional `i`, `j`.                                                                                                                                                                                                                                                                                                          |
...
| `analysis/Pos{n}/fit.csv`                                                                                                         | Kinetic fit (`roi,baseline_intensity,protein_lifetime,mrna_lifetime,onset_time,expression_rate,success`; same channel rule). Internal `*_degradation_rate` / `expression_amplitude` are not written.                                                                                                                                                                                                                                  |
| `results/<sample>/`                                                                                                               | Per-sample packs: `traces.xlsx` / `auc.xlsx` / `fit.xlsx` (prefix `pos`; no `slide_channel` / `sample` columns) plus `traces.png`, `traces_shared_y.png`, `traces_summary.png`, `traces_summary_shared_y.png`, `area.png`, `area_shared_y.png`, `traces_fit.png`, `traces_fit_shared_y.png`, `expression_rate_vs_onset_time.png`, `expression_rate_vs_mrna_lifetime.png`. No `*_log` or `area_summary`. No shared-y for the scatters. |

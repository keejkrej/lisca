...
Canonical workspace table schema: [`schema.md`](./schema.md).

| Path                                                                                                                              | Role                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `assay.json`                                                                                                                      | Nested domain contract (`type`, `data`, `workspace`, `interval`, `samples`, optional `analysis` with `channels` / `sampleChannels`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `bbox/PosN.csv`                                                                                                                   | Site boxes. Required columns: `roi`, `x`, `y`, `w`, `h` (integers, top-left origin, `w`/`h` > 0). Old `crop` headers are rewritten to `roi` by lisca workspace migrations, then `roi` is required. Optional `i`, `j`.                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `analysis/Pos{n}/ch{n}.csv`                                                                                                       | Per-position intensity metrics (`roi,t,area,background,sum,corrected`; no `pos` / `slide_channel`; `t` from `timeIndices`). `background` and `sum` are QC columns. Segmented: mask fg + **median** bg; `analysis.skipSegment`: whole ROI + **10th-percentile** bg. CSV only.                                                                                                                                                                                                                                                                                                                                                                     |
...
| `analysis/Pos{n}/fit.csv`                                                                                                         | Kinetic fit (`roi,baseline_intensity,onset_time,expression_rate,mrna_lifetime,protein_lifetime,success`; `channel` only when that Pos has multiple signal CSVs).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `results/<sample>/`                                                                                                               | Per-sample packs: `traces.xlsx` (`pos,roi,t,area,background,sum,corrected`), `auc.xlsx` (`pos,roi,auc`), `fit.xlsx` (`pos,roi,baseline_intensity,onset_time,expression_rate,mrna_lifetime,protein_lifetime,success`); `channel` only when that sample has multiple signal channels. No `slide_channel` / `sample` columns. PNG: `traces.png`, `traces_shared_y.png`, `traces_summary.png`, `traces_summary_shared_y.png`, `area.png`, `area_shared_y.png`, `traces_fit.png`, `traces_fit_shared_y.png`, `expression_rate_vs_onset_time.png`, `expression_rate_vs_mrna_lifetime.png`. No `*_log` or `area_summary`. No shared-y for the scatters. |

...
def test_load_slide_positions_supports_ranges_and_deduplicates(tmp_path: Path) -> None:
    slide_path = tmp_path / 'slide.json'
    slide_path.write_text(json.dumps({'1': ['12-14', 14, '16', 18]}), encoding='utf-8')

    assert timeseries.load_slide_positions(slide_path, 1) == [12, 13, 14, 16, 18]

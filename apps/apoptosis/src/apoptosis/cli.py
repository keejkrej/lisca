...
COMMANDS: dict[tuple[str, str], CommandHandler] = {
    ...
    ("bf-class", "events"): lambda argv: bf_class_cli.events_main(argv),
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    if args[0] == "correlation":
        correlation.main(args[1:], prog_name="apoptosis correlation")
        return
    if len(args) < 2:

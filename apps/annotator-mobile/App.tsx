...
/** Where the Vite app is served (use your LAN IP for a physical iPad, e.g. http://192.168.1.10:5174). */
const WEB_URL = process.env.EXPO_PUBLIC_LISCA_WEB_URL ?? 'http://127.0.0.1:5174';

...
/** Where the Vite app is served (use your LAN IP for a physical iPad, e.g. http://192.168.1.10:5175). */
const WEB_URL = process.env.EXPO_PUBLIC_LISCA_WEB_URL ?? 'http://127.0.0.1:5175';
      ...
      {showDevHint ? (
        <View style={styles.hint} pointerEvents="none">
          <Text style={styles.hintText}>
            Set EXPO_PUBLIC_LISCA_WS_URL to your remote ws/wss URL. Web UI: EXPO_PUBLIC_LISCA_WEB_URL
            (default {WEB_URL}).
          </Text>
        </View>
      ) : null}

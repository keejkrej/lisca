...
export function StudioAnnotateNav() {
  ...
  const positionOptions = () =>
    toAxisNavigationOptions(nav.scan?.positions.map((entry) => entry.pos) ?? []);
  const roiOptions = () =>
      ...
      <div class="flex min-h-0 flex-col gap-2 p-3">
        <FrameNavigation
          position={{
            ...
            nextDisabled:
              findNavigationOptionIndex(positionOptions(), posValue()) >=
          ...
          roi={{
            ...
            nextDisabled:
              findNavigationOptionIndex(roiOptions(), roiValue()) >= roiOptions().length - 1,
            onChange: (value) =>
              nav.changeSelection(() =>
                nav.setSelection({
                  roi: value,
          ...
          channel={{
            ...
            nextDisabled:
              findNavigationOptionIndex(channelOptions(), channelValue()) >=

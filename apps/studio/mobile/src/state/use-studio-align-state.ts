...
export function useStudioAlignState(): StudioAlignState {
  ...
  const saveAndAdvance = async () => saveAndAdvanceWithModelCells(variationExcludeCells());
  return {
    workspacePath,
    source,
    scan,

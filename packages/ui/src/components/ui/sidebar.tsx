...
import { Tooltip, TooltipContent, type TooltipContentProps, TooltipTrigger } from "#ui/tooltip";
...
const SidebarRail = (props: ComponentProps<"button">) => {
  ...
  return (
    <button
      ...
      class={cn(
        "absolute inset-y-0 z-20 z-sidebar-rail hidden w-4 -translate-x-1/2 transition-[transform,background-color] ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-0.5 group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",

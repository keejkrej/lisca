...
export type DockSectionProps = Omit<SectionProps, "class" | "contentClassName"> & {
  class?: string;
...
export function DockSection(props: DockSectionProps) {
  ...
  return (
    <Section
      ...
      contentClassName={cn("flex min-h-0 flex-1 flex-col justify-center gap-2", local.contentClassName)}
      {...sectionProps}
    >
      {local.children}
    </Section>

...
const centeredClassByLayout: Record<DockGridLayout, string> = {
  "2x1": "grid-rows-2 grid-cols-[12rem]",
  "2x2": "grid-rows-2 grid-cols-[repeat(2,12rem)]",
  "2x3": "grid-rows-2 grid-cols-[repeat(3,12rem)]",
};
  ...
  return (
    <div
      className={cn(
        ...
        centered
          ? cn(
              "mx-auto w-max justify-items-center place-content-center",
              centeredClassByLayout[layout],
            )
          : cn("w-full", layoutClassByLayout[layout]),
        className,
      )}
      {...props}
    >

...
use imaging_smb_io::{SmbHandle, SmbSessionProvider};
...
pub fn register_imaging_smb_provider() -> Result<(), String> {
    imaging_smb_io::register_provider(std::sync::Arc::new(LiscaSmbProvider))
}
